...
import styles from '../airbnb-base-extended/style';
import globals from 'globals';
import { Linter } from 'eslint';

const baseStylesRules = styles[0].rules! satisfies Partial<Linter.RulesRecord>;
// eslint-disable-next-line @typescript-eslint/no-non-null-assertion
const dangleRules = baseStylesRules['no-underscore-dangle']!;
...
export default tsEslint.config([
  {
    ...
    rules: {
      'no-underscore-dangle': [
        (dangleRules as Linter.RuleSeverityAndOptions)[0],
        {
          ...(dangleRules as Linter.RuleSeverityAndOptions)[1],
          allow: (dangleRules as Linter.RuleSeverityAndOptions)[1].allow.concat(['__REDUX_DEVTOOLS_EXTENSION_COMPOSE__']),
        },
      ],
